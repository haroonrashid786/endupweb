...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Blocks</h4>
                {{--                {{ $errors }} --}}
    ...
    <script>
        function format(d) {
            ...
            console.log(d.riders);
            return (
                '<h3>Block Information <b>' + d.number + '</b></h3>' +
                ...
                '</tr>' +
                '<tr>' +
                '<td><b>Select Rider: ' + d.riders + '</b></td>' +
                '</tr>' +
            ...
            fetch('/change/rider', {
                ...
                .then((data) => {
                    ...
                    if (data.status === 200) {
                        Snackbar.show({
                            pos: 'bottom-center',
                            text: 'Block has been assigned to rider',
                        ...
                        Snackbar.show({
                            pos: 'bottom-center',
                            text: 'Rider has been removed from the block',
