...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Assign Rider</h4>
                {{--                {{ $errors }} --}}
                ...
                <form action="{{ route('assign.order') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" onchange="assign(this)" required name="pickup_date_time" pattern="\d{4}/\d{2}/\d{2} \d{2}:\d{2}" class="form-control datetimepicker">
                        ...
                        <div class="form-group col-6">
                            <label for="">Warehouse<span class="text-danger">*</span></label>
                                ...
                                <select name="warehouse" class="form-control" required readonly id="warehouse_id">
                            ...
                            <a href="javascript:void(0);" onclick="verifyDistance()" style="float: right">Verify distance</a>
                        </div>
    ...
    <script>
        var droplat;
        var droplong;
        // var input_dropoff_coordinates = document.querySelector('#input_dropoff_coordinates');

        //     document.addEventListener("DOMContentLoaded", function () {
        //   fetch('https://maps.googleapis.com/maps/api/geocode/json?address={{ ucwords($order->enduser_address) }}&key={{ env('GOOGLE_MAP_KEY') }}')--}}
        //       .then(response => response.json())--}}
        //       .then(data => {--}}
        //           console.log(data);--}}
        //       // console.log(data.results[0].geometry.location.lat);--}}
        //           // console.log(data.results[0].geometry.location.lng);--}}
        //              droplat = data.results[0].geometry.location.lat;--}}
        //        droplong = data.results[0].geometry.location.lng;--}}
        //        // dropOff = `${data.results[0].geometry.location.lat}, ${data.results[0].geometry.location.lng}`;--}}
        //        // console.log(dropOff);--}}
        //        input_dropoff_coordinates.value = droplat + ', ' + droplong;--}}
        //           initialize(droplat, droplong)--}}
