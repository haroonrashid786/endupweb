@extends('layouts.app')
@section('title', 'Create Return Collection (Retailer)')
@section('content')
    <style>
        #map_canvas {
            height: 250px;
        ...
        <div class="col-12">
            <div class="">
                <ol class="breadcrumb m-0 ps-0">
                    ...
                    <li class="breadcrumb-item active">Create Return Collection (Retailer)</li>
                </ol>
            </div>
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Create Return Collection (Retailer)</h4>
                {{--                {{ $errors }} --}}
    ...
    <div class="w-100">
        <div class="row justify-content-between">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-6 text-left">
                                            {{ $order->retailer->user->name }} @if ($order->return != 0) <span class="badge badge-soft-danger">Return</span> @endif
                                        </div>
                                        <div class="col-6 text-end">
                                            Distance: <b>{{ $order->collector_distance }}</b>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul style="padding-left: 0;list-style: none;">
                                        ...
                                        <li><b>Retailer Address: </b>{{ $order->retailer->address }}</li>
                                    </ul>
                                </div>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="myLargeModalLabel">Items Information</h5>
            ...
            <div class="col-sm-4 bg-light p-4">
                ...
                <form action="{{ route('post.collector') }}" method="post">
                    @csrf
                    <input type="hidden" name="return_collection" value="1">
    ...
    <script>
        ...
        function verifyDistance() {
            ...
            fetch('/collector/verify_distance', {
                    method: 'POST', // or 'PUT'
                    headers: {
